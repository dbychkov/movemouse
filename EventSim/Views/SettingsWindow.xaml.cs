...
namespace ellabi.Views
{
    public partial class SettingsWindow
    {
        ...
        private void ContactLink_OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            try
            {
                var result = MessageBox.Show("If you are having issues with EventSim or have any questions, you may find the Troubleshooting section in the Wiki useful.\r\n\r\nWould you like to visit the Wiki now?", "Visit Troubleshooting Page", MessageBoxButton.YesNo, MessageBoxImage.Question);
        ...
        private void FollowLogButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                powershell.StartInfo.Arguments = $"-ExecutionPolicy Bypass -Command \"$Host.UI.RawUI.WindowTitle = 'EventSim Log';Get-Content -Path:'{StaticCode.LogPath}' -Tail:500 -Wait";
                powershell.Start();
            }
            catch (Exception ex)
            {
