...
namespace ellabi
{
    public static class StaticCode
    {
        ...
        public const string HomePageUrl = "http://www.example.com";
        public const string HelpPageUrl = "https://www.example.com";
        public const string TwitterUrl = "https://www.example.com";
        public const string GitHubUrl = "https://www.example.com";
        public const string CronHelpUrl = "http://www.example.com";
        public const string TroubleshootingUrl = "https://www.example.com";
        public const string UpdateXmlUrl = "https://www.example.com";
        public const string MailAddress = "contact@example.com";
        public const string RunRegistryValueName = "EventSim";

        public static string WorkingDirectory = Path.Combine(Environment.ExpandEnvironmentVariables("%AppData%"), @"EventSim\EventSim");
        public static string TempDirectory = Path.Combine(Environment.ExpandEnvironmentVariables("%Temp%"), @"EventSim\EventSim");
        public static MoveMouseSource DownloadSource = MoveMouseSource.GitHub;

        public static string UpdateUrl;
        public static string ContactMailToAddress = $"mailto:{MailAddress}?subject=EventSim";
        ...
        public static void CreateLog()
        {
            try
            {
                ...
                _logPath = Path.Combine(StaticCode.DownloadSource == MoveMouseSource.MicrosoftStore ? ApplicationData.Current.LocalFolder.Path : TempDirectory, "EventSim.log");
